    ...
    <div class="singer">
      <div class="selectors">
        <div class="selectorItem">
          ...
          <second-nav-bar :second-nav-bar-data="languageSort" @clickSecondBarItem="areaItem" class="secondNavBar"></second-nav-bar>
        </div>
        <div class="selectorItem">
          <div class="title">分类：</div>
          <second-nav-bar :second-nav-bar-data="typeSort" @clickSecondBarItem="typeItem" class="secondNavBar"></second-nav-bar>
        </div>
        <div class="selectorItem">
          <div class="title">筛选：</div>
          <second-nav-bar :second-nav-bar-data="initialSort" @clickSecondBarItem="initialItem" class="secondNavBar"></second-nav-bar>
        </div>
      </div>
      <div class="listCardContainer">
        <list-card class="listCard" :list-card-data="singerList" @clickListCardItem="clickListCardItem" is-load @bottomLoad="bottomLoad"></list-card>
      </div>
